var listanombres = ["ESL_SC2", "OgamingSC2", "freecodecamp" , "storbeck", "RobotCaleb", "food"];
...
function customsearch() {
    ...
    if (custom === "") {
        ...
        $("#modalmoreinfobody").html("Creo que es mejor que primero definas que quieres buscar!");
        ...
        $.getJSON("https://api.twitch.tv/kraken/users/" + custom + "?client_id=39r473fxxkvfbns0nbddmvmvi2457v", function (json) {
            ...
            $("#modalavatar").removeClass("d-block");
            $("#modalmoreinfoTitle").text("Error!");
            $("#modalmoreinfobody").html("<strong>404</strong> Usuario no encontrado, por favor ingresa el nombre de un canal valido");
